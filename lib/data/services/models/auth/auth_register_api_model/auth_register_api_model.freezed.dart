...
mixin _$AuthRegisterApiModel {
  ...
  $AuthRegisterApiModelCopyWith<AuthRegisterApiModel> get copyWith =>
      _$AuthRegisterApiModelCopyWithImpl<AuthRegisterApiModel>(
          this as AuthRegisterApiModel, _$identity);
...
abstract mixin class $AuthRegisterApiModelCopyWith<$Res> {
  factory $AuthRegisterApiModelCopyWith(AuthRegisterApiModel value,
          $Res Function(AuthRegisterApiModel) _then) =
      _$AuthRegisterApiModelCopyWithImpl;
  @useResult
  $Res call({String authPayload, bool isNewUser});
}
...
extension AuthRegisterApiModelPatterns on AuthRegisterApiModel {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AuthRegisterApiModel value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String authPayload, bool isNewUser)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _AuthRegisterApiModel() when $default != null:
        return $default(_that.authPayload, _that.isNewUser);
      case _:
        return orElse();
    }
  }
...
class _AuthRegisterApiModel implements AuthRegisterApiModel {
  const _AuthRegisterApiModel(
      {required this.authPayload, this.isNewUser = false});
  factory _AuthRegisterApiModel.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AuthRegisterApiModelCopyWith<_AuthRegisterApiModel> get copyWith =>
      __$AuthRegisterApiModelCopyWithImpl<_AuthRegisterApiModel>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AuthRegisterApiModelToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AuthRegisterApiModel &&
            (identical(other.authPayload, authPayload) ||
                other.authPayload == authPayload) &&
            (identical(other.isNewUser, isNewUser) ||
                other.isNewUser == isNewUser));
...
/// @nodoc
abstract mixin class _$AuthRegisterApiModelCopyWith<$Res>
    implements $AuthRegisterApiModelCopyWith<$Res> {
  factory _$AuthRegisterApiModelCopyWith(_AuthRegisterApiModel value,
          $Res Function(_AuthRegisterApiModel) _then) =
      __$AuthRegisterApiModelCopyWithImpl;
  @override
  @useResult
  $Res call({String authPayload, bool isNewUser});
}
